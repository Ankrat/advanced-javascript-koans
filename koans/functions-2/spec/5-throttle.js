...
describe('Throttle', function () {
  it('should never invoke the specified function twice within specified time interval', function () {
  ...
  it('should just demonstrate throttle in action - no tests', function () {
