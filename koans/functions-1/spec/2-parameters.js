describe('function parameters', function () {
  it('should understand how parameters are passed in javascript', function () {
  ...
  it('should understand parameters', function () {
    var f = function (arg) {
      delete arg;
      return arg;
    };
  ...
  it('should understand implicit parameter \'arguments\'', function () {
    var dec = function () {
  ...
  it('should understand arguments.callee', function () {
  ...
  it('should understand function length', function () {
