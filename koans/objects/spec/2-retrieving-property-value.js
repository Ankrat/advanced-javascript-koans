describe('Retrieving properties', function () {
  ...
  it('should know how to use . and [] operators to retrieve property values', function () {
    expect(samurai.name).toBe(__);
    expect(samurai['name']).toBe(__);
  });
  it('should know that property names are case-sensitive', function () {
    expect(samurai.Name).toBe(__);
  });
  it('should know how to use variable property name', function () {
    var propertyName = 'name';
    expect(samurai.propertyName).toBe(__);
    expect(samurai[propertyName]).toBe(__);
  });
  it('should know default operator ||', function () {
    samurai.title = '';
  ...
  it('should know guard operator &&', function () {
  ...
  it('should know how to combine default and guard operators', function () {
    var samurai2, samurai3 = {
      address: {
        postcode: '18+'
      }
  ...
  it('should understand hasOwnProperty', function () {
  ...
  it('should understand propertyIsEnumerable', function () {
