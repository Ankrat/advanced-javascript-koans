...
describe('Delete', function () {
  ...
  it('should understand delete operator vs. setting property value to undefined', function () {
    var object = {
  ...
  it('should understand how execution context affects delete operator', function () {
    expect(a).toBe(__);
